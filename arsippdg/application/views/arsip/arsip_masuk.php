...
<div class="container">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted">Daftar arsip surat masuk yang telah diarsipkan</p>
    </div>
    ...
    <form method="get" class="mb-4">
        ...
        <div class="row g-2 mt-2">
            ...
            <div class="col-md-2">
                <a href="<?= site_url('arsip/masuk'); ?>" class="btn btn-outline-secondary w-100">
                    Reset
                </a>
            </div>
        </div>
     ...
     <div class="recent-table">
         <div class="table-responsive">
             <table class="table table-hover align-middle">
                 ...
                 <?php endforeach; else: ?>
                     <tr>
                         <td colspan="7" class="text-center text-muted py-4">Tidak ada data arsip masuk</td>
                     </tr>
                 <?php endif; ?>
