    ...
    <div class="container">
        ...
        <div class="mb-4">
            <h2 class="section-title">
                <i class="bi bi-archive-fill"></i> Detail Arsip Surat Masuk
            </h2>
            <p class="text-muted">
                Detail arsip surat masuk yang telah diarsipkan
            </p>
        </div>
            ...
            <div class="col-lg-5">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h6 class="mb-0">Informasi Arsip Surat Masuk</h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="row g-4 mt-4">
            <div class="col-lg-12">
                <div class="d-flex justify-content-between">
                    <a href="<?= site_url('arsip/masuk') ?>" class="btn btn-outline-secondary">
