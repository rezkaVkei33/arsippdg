...
<section class="dashboard-content">
    <div class="container">
        ...
        <div class="mb-4">
            ...
            <p class="text-muted">
                Detail surat masuk dan arsip digital
            </p>
        </div>
            ...
            <div class="col-lg-5">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h6 class="mb-0">Informasi Surat Masuk</h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="mt-4 d-flex justify-content-between">
            ...
            <div>
                ...
                <a href="<?= site_url('suratmasuk/update/'.$surat->id) ?>" class="btn btn-warning">
...
<div class="modal fade" id="statusModal<?= $surat->id ?>" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post"
                  action="<?= site_url('suratmasuk/change_status/'.$surat->id) ?>">
